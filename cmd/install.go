...
func install(lastVer string, db *pbdb.DB, fs stuffbin.FileSystem, prompt, idempotent bool) {
...
func installSchema(curVer string, db *pbdb.DB, fs stuffbin.FileSystem) error {
...
func installCampaign(campTplID, archiveTplID int, q *models.Queries) {
	...
	if _, err := q.CreateCampaign.Exec(uuid.Must(uuid.NewV4()),
		...
		<p>Here is a <a href="{{ RootURL }}@TrackLink">tracked link</a>.</p>
		...
		<pre>&lt;a href=&quot;{{ RootURL }}&#064;TrackLink&quot;&gt;&lt;/a&gt;</pre>
...
func checkSchema(db *pbdb.DB) (bool, error) {
