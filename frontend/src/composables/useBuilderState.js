      ...
      return {
        ...
        data: {
          ...
          schema: [
            ...
            { ...schema("fromEmail", "From Email Override", "text"), description: "Optional explicit From address. Leave blank to use the selected messenger default sender.", placeholder: "Team <team@example.com>" },
            ...
            { ...schema("messenger", "Messenger", "text"), description: "Messenger backend to use. Defaults to email and can be selected from configured messengers in the inspector.", placeholder: "email" },
